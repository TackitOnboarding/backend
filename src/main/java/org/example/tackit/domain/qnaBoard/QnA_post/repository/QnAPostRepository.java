...
public interface QnAPostRepository extends JpaRepository<QnAPost, Long> {
    ...
    Page<QnAPost> findByWriterAndActiveStatus(MemberOrg writer, ActiveStatus status, Pageable pageable);
    Page<QnAPost> findByWriterIdAndActiveStatus(Long orgId, ActiveStatus status, Pageable pageable);

    List<QnAPost> findTop3ByWriterIdAndActiveStatusOrderByViewCountDescScrapCountDesc(Long orgId, ActiveStatus status);
