package org.example.tackit.domain.tipBoard.Tip_comment.service;
...
public class TipCommentService {
  ...
  // 댓글 수정 (작성자만 가능)
  @Transactional
  public TipCommentResponseDto updateComment(Long commentId, TipCommentUpdateDto dto, String email,
      Long orgId) {
    MemberOrg member = memberOrgRepository.findByMemberEmailAndId(email, orgId)
        .orElseThrow(() -> new IllegalArgumentException("존재하지 않는 사용자입니다."));
