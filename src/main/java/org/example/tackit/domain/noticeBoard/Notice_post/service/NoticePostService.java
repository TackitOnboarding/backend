...
import org.example.tackit.domain.entity.NoticeScrap;
...
public class NoticePostService {
  ...
  // [ 게시글 작성 ]
  @Transactional
  public NoticePostRespDto createPost(NoticePostReqDto dto, MultipartFile image, String email,
  ...
  // [ 게시글 수정 ] : 작성자만
  @Transactional
  public NoticePostRespDto update(Long id, UpdateNoticeReqDto req, MultipartFile image,
      String email, Long orgId) throws IOException {
  ...
  public NoticeScrapRespDto toggleScrap(Long postId, String email, Long orgId) {
    ...
    Optional<NoticeScrap> existing = noticeScrapRepository.findByMemberAndNoticePost(
        memberProfile.getMember(), post);
