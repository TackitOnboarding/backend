package org.example.tackit.domain.freeBoard.Free_comment.service;
...
public class FreeCommentService {
  ...
  // [ 댓글 수정 ] : 작성자만 가능
  @Transactional
  public FreeCommentRespDto updateComment(Long commentId, FreeCommentUpdateDto dto, String email,
      Long orgId) {
    MemberOrg member = memberOrgRepository.findByMemberEmailAndId(email, orgId)
        .orElseThrow(() -> new IllegalArgumentException("존재하지 않는 사용자입니다."));
